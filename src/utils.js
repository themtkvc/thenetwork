  ...
  return [
    {
      ...
      notes: "Yapay zeka alanında çok güçlü bir ağı var. Avrupa'dıki en iyi kontak kişilerden biri.",
      opportunities: 'AB Horizon Europe hibe başvurusu için ortaklık. 2026 Q3 hedefi.',
    ...
    },
    {
      ...
      email: 'jchen@sgventures.com', phone: '+65 9123 4567',export function uid() {
  return Date.now().toString(36) + Math.random().toString(36).slice(2, 7);
}
...
export function parseCSVLine(line) {
  ...
  return result;
      ...
      lastContact: '2026-01-28', nextFollowup: '2026-03-05',
      communications: [
        { id: uid(), date: '2026-01-28', type: 'call', note: 'Yeni fon stratejisi hakkında 45 dk. konuştuk. Fintech alanına odaklanıyor.' }
      ],
      notes: "Güneydоğu Asya'dıki en aktif yatırımcılardan biri. Her yıl Kasım'da Singapore FinTech Festival'e katılıyor.",
      opportunities: "Seri A turunda lider yatırımcı olabilir. Fintech ürünümüzü sunmak için Nisan'da sunum planlandı.",
    ...
    },
    {
      ...
      lastContact: '2025-12-05', nextFollowup: '2026-04-01',
      communications: [
        { id: uid(), date: '2025-12-05', type: 'linkedin', note: 'WHO konferansı sonrası bağlantı isteği gönderildi ve kabul edildi.' }
      ],
      notes: 'WHO Danışma Kurulu üyesi. Akademik işbirlikleri için çok değerli.',
      opportunities: "Ortak yayın için araştırma verisi paylaşımı. Ekim'deki Lagos Sağlık Zirvesi'ne davet.",
